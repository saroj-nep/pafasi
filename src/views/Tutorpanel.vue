      ...
      <div v-if="t.email == email">
        ...
        <!-- <div class="flex justify-center">
          <router-link v-if="t.tutor == 1" to="/caseresults3"
            ><br /><Button
              class="btn mr-2 shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
              text="Fall 3: Fr. Meier"
          /></router-link>
          <router-link v-if="t.tutor == 1" to="/caseresults3_re"
            ><br /><Button
              class="btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
        ...
        <!-- <div class="flex justify-center">
          <router-link v-if="t.tutor == 1" to="/caseresults4"
            ><br /><Button
              class="btn mr-2 shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
              text="Fall 4: Fr. Olewski"
          /></router-link>
          <router-link v-if="t.tutor == 1" to="/caseresults4_re"
            ><br /><Button
              class="btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
        ...
        <div class="flex justify-center">
          <router-link v-if="t.tutor == 1" to="/caseresults5"
            ><br /><Button
              class="btn mr-2 shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
              text="Fall 5: Hr. Rigas"
          /></router-link>
          <router-link v-if="t.tutor == 1" to="/caseresults5_re"
            ><br /><Button
              class="btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
         ...
         <div class="flex justify-center">
          <router-link v-if="t.tutor == 1" to="/caseresults6"
            ><br /><Button
              class="btn mr-2 shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
              text="Fall 6: Fr. Holderbaum"
          /></router-link>
          <router-link v-if="t.tutor == 1" to="/caseresults6_re"
            ><br /><Button
              class="btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-2xl"
