...
<br>
 ...
 <div class="flex flex-col">
  ...
  <script >
    ...
    this.allstudents(); this.allSubmits();this.allCounters();this.counterbtn=0;
        ...
        counterBtn(){
          ...
          allCounters(){
            axios.get( "./Api/bauch_api.php?action=getoriginalcounters",)
    ...
    .then((response) => {this.counters=response.data;} )
        ...
        hauptmenu(){this.$router.push("/tutorpanel");},
         ...
         axios.get( "./Api/bauch_api.php?action=getoriginalsubmit",)
  ...
  axios.get( "./Api/bauch_api.php?action=getoriginaldownloadstuff", {params: {
    'user': e,
  }})
