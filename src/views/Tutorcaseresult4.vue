...
export default {
  ...
  methods: {
    ...
    allCounters() {
      axios
        .get("./Api/bauch_api.php?action=getoriginalcounters")
    ...
    allSubmits() {
      axios
        .get("./Api/bauch_api.php?action=getoriginalsubmit")
        .then((response) => {
    ...
    downloadtrigger(e) {
      ...
      axios
        .get("./Api/bauch_api.php?action=getoriginaldownloadstuff", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/bauch_api.php?action=getoriginalisclicked", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/bauch_api.php?action=getoriginalbloods", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/bauch_api.php?action=getoriginalurines", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/bauch_api.php?action=getoriginalstools", {
          params: {
            user: e,
          },
        })
    ...
    btnprint() {
      ...
      var opt = {
        margin: 1,
        filename: "Diagnoseergebnisse_Olewski.pdf",
