              ...
              >
                ...
                <div class="fallbeschreibung pl-10" style="width: 75%">
                  ...
                  <p style="border-radius: 5px">
                    "Es ist Montagmorgen. Frau Anke Meier guter AZ,
                    vollschlanker EZ, kommt notfallmäßig. Sie bewegt sich leicht
                    gekrümmt und vorsichtig. Sie habe am Wochenende einen
                    Hexenschuss beim Waschmaschine ausräumen erlitten. Danach
                    konnte sie sich zuerst "gar nicht mehr" bewegen. Zuerst habe
                    sie sich vor der Waschmaschine auf den Boden gelegt und auf
                    Besserung gewartet. Nach einiger Zeit ging es dann, aber
                    jede neue Bewegung sei kaum auszuhalten gewesen. Sie konnte
                    sich jedoch auf die Couch und später ins Bett schaffen.
                    Nachts habe sie kaum geschlafen und habe sich aufgrund
                    bleibender Beschwerden am Sonntag in die Notaufnahme fahren
                    lassen. Dort sei sie untersucht und mit Schmerzmedikation
                    wieder nach Hause geschickt worden. Sie klagt nun über
                    anhaltend starke Schmerzen bei Bewegung und dadurch starke
                    Bewegungseinschränkung. Außerdem bräuchte sie heute am
                    Montag eine Krankmeldung für die Arbeit."
                  </p>
                  <!-- </div> -->
                  <!-- <div class="column left"> -->
                  <!-- </div> -->
...
export default {
  ...
  methods: {
    ...
    pagestatus() {
      axios
        .get("./Api/meier_api.php?action=getpagestatus")
    ...
    sendthesteps() {
      ...
      data.append(
        "step",
        "Der Benutzer ist auf der Seite Fall 2: Hr. Meier Seite gelandet."
      );
      data.append("onlineuser", localStorage.email);
      axios
        .post(
