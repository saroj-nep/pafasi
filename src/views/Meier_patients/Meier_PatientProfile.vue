        ...
        <div class="shadow-md shadow-green-600 bg-green-50 " style="display:flex;  padding: 20px; margin-left:10px; padding-left: 40px; border-radius: 10px;">
          <div class=" " style="width: 20%;">
            <div class="grid grid-cols-1 pl-6 ">
              <img src= "../../assets/Meier.jpg" class="object-contain h-48 " alt="Patient Image" style="top: 20px;" />   
         
            <div class="flex content-start "><h1><b> Fr.  Anke Meier</b></h1></div>
              <div class="flex content-start   ">Alter: 41 J</div>
          ...
          <div class="fallbeschreibung pl-10" style="width: 75%">
            ...
            <br>
            <p style="border-radius: 5px">"Es ist Montagmorgen. Frau Anke Meier guter AZ, vollschlanker EZ, kommt notfallmäßig. Sie bewegt sich leicht gekrümmt und vorsichtig. Sie habe am Wochenende einen Hexenschuss beim Waschmaschine ausräumen erlitten. Danach konnte sie sich zuerst "gar nicht mehr" bewegen. Zuerst habe sie sich vor der Waschmaschine auf den Boden gelegt und auf Besserung gewartet. Nach einiger Zeit ging es dann, aber jede neue Bewegung sei kaum auszuhalten gewesen. Sie konnte sich jedoch auf die Couch und später ins Bett schaffen. Nachts habe sie kaum geschlafen und habe sich aufgrund bleibender Beschwerden am Sonntag in die Notaufnahme fahren lassen. Dort sei sie untersucht und mit Schmerzmedikation wieder nach Hause geschickt worden. Sie klagt nun über anhaltend starke Schmerzen bei Bewegung und dadurch starke Bewegungseinschränkung. Außerdem bräuchte sie heute am Montag eine Krankmeldung für die Arbeit."					
...
import Anamnese from '@/components/Meier_Anamnese.vue';
import Patientenakte from '../../components/Meier_Patientenakte.vue';
import Untersuchen from '../../components/Meier_Untersuchen.vue';
import Labaratory from '../../components/Meier_Labaratory.vue';
import Facharzt from '../../components/Meier_Facharzt.vue';
import Sendsubmit from '../../components/Meier_Sendsubmit.vue';
...
import TotalNextday from '@/components/Meier_Labaratory/Meier_TotalNextday.vue';
import Afterlab from '@/components/Meier_Afterlab.vue';
import Submit2 from '@/components/Meier_Submit2.vue';
...
import Submit3 from '@/components/Meier_Submit3.vue';
import Prints from '@/components/Meier_Prints.vue'; 
...
printstrigger(){
        ...
        .post(
          // "./Api/api.php?action=login",
           "./Api/meier_api.php?action=emptydiagnosis",
          data
        )
        .then(res => {
          if (res.data.error) {
...
pagestatus(){
  ...
  axios.get( "./Api/meier_api.php?action=getpagestatus")
    ...
    sendthesteps(){
    var data = new FormData();
     data.append("step","Der Benutzer ist auf der Seite Fall 2: Hr. Meier Seite gelandet.")
    data.append("onlineuser",localStorage.email);
axios
        .post(
