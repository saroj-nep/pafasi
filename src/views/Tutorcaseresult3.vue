<template>
  ...
  <div class="ml-40 mr-40 mt-5 mb-20">
    ...
    <div id="htmlcontent" style="display: none" class="htmlcontent">
      <h1 style="text-align: center" class="font-bold py-2">Fall: Fr. Meier</h1>
...
export default {
  ...
  methods: {
    ...
    allCounters() {
      axios
        .get("./Api/meier_api.php?action=getoriginalcounters")
    ...
    allSubmits() {
      axios.get("./Api/meier_api.php?action=getoriginalsubmit").then((response) => {
    ...
    downloadtrigger(e) {
      ...
      axios
        .get("./Api/meier_api.php?action=getoriginaldownloadstuff", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/meier_api.php?action=getoriginalisclicked", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/meier_api.php?action=getoriginalbloods", {
          params: {
            user: e,
          },
        })
        ...
        axios
        .get("./Api/meier_api.php?action=getoriginalurines", {
          params: {
            user: e,
          },
        })
        ...
        axios
        .get("./Api/meier_api.php?action=getoriginalstools", {
          params: {
            user: e,
          },
        })
    ...
    btnprint() {
      ...
      var opt = {
        margin: 1,
        filename: "Diagnoseergebnisse_meier.pdf",
    ...
    allstudents() {
      axios.get("./Api/meier_api.php?action=getoriginalcounters").then((response) => {
