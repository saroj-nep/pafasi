<template>
  ...
  <div class="ml-40 mr-40 mt-5 mb-20">
    ...
    <div id="htmlcontent" style="display: none" class="htmlcontent">
      <h1 style="text-align: center" class="font-bold py-2">Fall: Hr. Rigas</h1>
...
export default {
  ...
  methods: {
    ...
    allCounters() {
      axios
        .get("./Api/rigas_api.php?action=getcounters")
    ...
    allSubmits() {
      axios.get("./Api/rigas_api.php?action=getsubmit").then((response) => {
    ...
    downloadtrigger(e) {
      ...
      axios
        .get("./Api/rigas_api.php?action=getdownloadstuff", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/rigas_api.php?action=getisclicked", {
          params: {
            user: e,
          },
        })
      ...
      axios
        .get("./Api/rigas_api.php?action=getbloods", {
          params: {
            user: e,
          },
        })
        ...
        axios
        .get("./Api/rigas_api.php?action=geturines", {
          params: {
            user: e,
          },
        })
        ...
        axios
        .get("./Api/rigas_api.php?action=getstools", {
          params: {
            user: e,
          },
        })
    ...
    btnprint() {
      ...
      var opt = {
        margin: 1,
        filename: "Diagnoseergebnisse_Rigas.pdf",
    ...
    allstudents() {
      axios.get("./Api/rigas_api.php?action=getcounters").then((response) => {
