              ...
              >
                <div class=" " style="width: 20%">
                  <div class="grid grid-cols-1 pl-6">
                    ...
                    <div class="flex content-start">
                      <h1><b> Fr. Daria Olewski</b></h1>
                    </div>
                    <div class="flex content-start">Alter: 29 J</div>
                ...
                <div class="fallbeschreibung pl-10" style="width: 90%">
                  ...
                  <p style="border-radius: 5px">
                    "Es ist Donnerstagvormittag. Frau Daria Olewski kommt zur Verlaufsbeurteilung, nachdem sie gestern notfallmäßig mit starken Bauchschmerzen von Ihrem Kollegen in Ihrer Gemeinschaftspraxis gesehen wurde. Ihr Kollege ist heute krank. Sie entnehmen der Aktennotiz Ihres Kollegen, dass die Untersuchung gestern keine eindeutige Diagnose ergab. Er vermerkte, dass der Bauch weich war, keine Abwehrspannung vorlag und auch im Ultraschall keine akute Pathologie sowie keine freie Flüssigkeit sichtbar war. Er entschied sich daher, Labor abzunehmen (kleines Blutbild und Entzündungswerte) und die Patientin für den nächsten Tag wiedereinzubestellen. Ihnen liegen nun die Laborbefunde des Vortages vor. Daran sehen Sie, dass Frau Olewski gestern noch normwertige Leukozytenzahl aufwies (9.850 /µl, Normbereich 3.800-10.500 /µl), jedoch eine CRP-Erhöhung von 24,3 mg/l (Normwert &lt;5 mg/l). Die sonstigen erhobenen Werte waren unauffällig. Sie rufen die Patientin auf, um sich selbst ein Bild zu machen.
Es handelt sich um eine junge, etwas füllige Patientin mit leichtem osteuropäischem Akzent. Frau Olewski geht gebeugt, leicht humpelnd und sehr vorsichtig, stützt sich beim Hinsetzen mit den Händen ab und wirkt schmerzgeplagt (verzerrtes Gesicht). Sie gibt an, die Schmerzen seien schlimmer geworden."
                  </p>
                  <!-- </div> -->
                  <!-- <div class="column left"> -->
                  <!-- </div> -->
...
import Anamnese from "@/components/Bauch_Anamnese.vue";
import Patientenakte from "../../components/Bauch_Patientenakte.vue";
import Untersuchen from "../../components/Bauch_Untersuchen.vue";
import Labaratory from "../../components/Bauch_Labaratory.vue";
import Facharzt from "../../components/Bauch_Facharzt.vue";
import Sendsubmit from "../../components/Bauch_Sendsubmit.vue";
...
import TotalNextday from "@/components/Bauch_Labaratory/Bauch_TotalNextday.vue";
import Afterlab from "@/components/Bauch_Afterlab.vue";
import Submit2 from "@/components/Bauch_Submit2.vue";
import Specialties from "@/components/Bauch_Facharzt/Bauch_Specialties.vue";
import Afterspecialties from "@/components/Bauch_Afterspecialties.vue";
import Submit3 from "@/components/Bauch_Submit3.vue";
import Prints from "@/components/Bauch_Prints.vue";
...
export default {
  ...
  methods: {
    ...
    printstrigger() {
      ...
      axios
        .post(
          ...
          "./Api/bauch_api.php?action=emptydiagnosis",
          data
        )
        .then((res) => {
          if (res.data.error) {
    ...
    pagestatus() {
      axios
        .get("./Api/bauch_api.php?action=getpagestatus")
    ...
    sendthesteps() {
      ...
      data.append(
        "step",
        "Der Benutzer ist auf der Seite Fall 2: Hr. Bauch Seite gelandet."
      );
      data.append("onlineuser", localStorage.email);
      axios
        .post(
