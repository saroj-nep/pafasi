...
import Blood from "./Meier_Labaratory/Meier_Blood.vue";
import Urine from "./Meier_Labaratory/Meier_Urine.vue";
import Stool from "./Meier_Labaratory/Meier_Stool.vue";
import TotalNextday from './Meier_Labaratory/Meier_TotalNextday.vue';
