      ...
      axios
        .post(
          // "./Api/api.php?action=login",
           "./Api/meier_api.php?action=sendsubmit1",
          data
        )
        .then(res => {
          if (res.data.error) {
...
if (a.checked==1){ if (b.checked==1){data.append("economy",22.22)} else {data.append("economy",5.55)}}
else {if (b.checked==1){data.append("economy",5.55)}}
...
if (a.checked==1){data.append("safety",100);
...
else if (c.checked==true){data.append("safety",50);
                     data.append("economy",-5.55 ) 
                     }
else if (d.checked==true){data.append("safety",75);
                     data.append("economy",-5.55 ) 
                     }   
else if (e.checked==true){data.append("safety",90);
                     data.append("economy",-5.55 ) 
                     }
else if (f.checked==true){data.append("safety",90);
                     data.append("economy",-5.55 ) 
                     }
else if (g.checked==true){data.append("safety",90);
 ...
 axios
        .post(
          // "./Api/api.php?action=countervariable",
          "./Api/meier_api.php?action=submitvariable",
          data
        )
        .then(res => {
          if (res.data.error) {
