...
axios
      ...
      axios
        ...
        .post(
          // "./Api/api.php?action=login",
           "./Api/bauch_api.php?action=sendsubmit4",
          data
        )
        .then(res => {
          if (res.data.error) {
        ...
        allCounters(){
            axios.get( "./Api/bauch_api.php?action=getcounters",)
    ...
    axios.get( "./Api/bauch_api.php?action=getnotes",)
...
var opt = {
  margin:       1,
  filename:     'Diagnoseergebnisse_Bauch.pdf',
