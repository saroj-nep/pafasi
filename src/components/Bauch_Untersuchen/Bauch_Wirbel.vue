<template>
  ...
  Kein Schulter- oder Beckenschiefstand, paravertebrale Muskulatur weich, kein WS-Klopfschmerz.
  </h3>
  <h3 id="naseanswer" style="display: none">
  Ante-, Retro-, Lateroflexion sowie Rotation mit normaler Beweglichkeit und schmerzfrei möglich, bei Vorbeugung kein Hinweis auf ausgeprägte Skoliose, kein Vorlaufphänomen, keine Schmerzen beim Vorbeugen oder Hochkommen, kein Rüttelschmerz, Lasègue bds. negativ, kein Meningismus.
  </h3>
  <h3 id="halsanswer" style="display: none">
    Kopfhaltung gerade, Kopfbewegung in alle Richtungen gut und schmerzfrei möglich, keine muskulären Resistenzen, Wirbelkörperfortsätze in einer Linie tastbar, kein Meningismus.  Kopfhaltung gerade, Kopfbewegung in alle Richtungen leicht schmerzhaft (die Patientin gibt an, sie habe immer ein wenig Nackenschmerzen von der Bürotätigkeit). Keine muskulären Resistenzen, Wirbelkörperfortsätze in einer Linie tastbar, kein Meningismus.
  </h3>
</template>
...
export default {
  ...
  methods: {
    ...
    counterInspektion() {
      ...
      data.append("wirbelinspektion", 0);
