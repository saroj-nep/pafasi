<template>
  ...
  <h3 id="inspektionanswer" style="display: none">
    Gesichtshaut rosig, Wangen glänzen. Mehrere unauffällige Naevi. Augen normal geöffnet, keine Ptosis, Pupillen seitengleich groß, Skleren und Konjunktiven nicht gerötet, Trigeminus-Druckpunkte nicht schmerzhaft, Schädelknochen palpatorisch o.p.B, Halsvenen nicht gestaut.
  </h3>
  ...
  <h3 id="mundanswer" style="display: none">
   Normales Lippenrot, keine Bläschen, keine Rhagarden, Mundöffnung gut durchführbar, Zahnreihen oben und unten vollständig, gepflegt, Munschleimhaut feucht, rosig, o.p.B, Rachenmandeln nicht vergrößert, keine Rötung, keine Beläge.
  </h3>
  <h3 id="ohrenanswer" style="display: none">
  Ohrmuschel o.p.B., mehrere Ohrpiercings bds., Gehörgänge bds. frei und reizlos, Trommelfelle bds. intakt, nicht gerötet.
  </h3>
  ...
  Keine Struma, keine Knoten, beweglich, schmerzfrei.
  </h3>
  <h3 id="halsanswer" style="display: none">
  Kopfhaltung gerade, Kopfbewegung in alle Richtungen gut und schmerzfrei möglich, keine muskulären Resistenzen, Wirbelkörperfortsätze in einer Linie tastbar, kein Meningismus.
  </h3>
