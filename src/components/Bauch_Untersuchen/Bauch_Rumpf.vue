...
import Thorax from '@/components/Bauch_Untersuchen/Bauch_Thorax.vue';
import Mammae from '@/components/Bauch_Untersuchen/Bauch_Mammae.vue';
import Wirbel from '@/components/Bauch_Untersuchen/Bauch_Wirbel.vue';
import Abdomen from '@/components/Bauch_Untersuchen/Bauch_Abdomen.vue';
