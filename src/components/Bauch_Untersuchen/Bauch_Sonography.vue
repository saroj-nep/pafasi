<template>
    ...
    <h1 style="font-size:1.5em; " class="h1 text-white text-center" ><b>Klicken Sie auf eine Körperregion (blauer Punkt), für die Sie das Ergebnis der Sonographie sehen möchten.​</b> </h1>
    </div>
    <br>
    <div class="grid grid-cols-2 gap-10">
    <div>
    <img class=" " src="@/assets/schneidersonography.jpg"  alt="schneider_sonography" usemap="#sono"> 
    <map name="sono">
...
<img id="img5_1" class="image2" style="display:none;align-self: right;;"  src="@/assets/schneider_uba1029.jpg" alt="schneider_hb">
<img id="img5_2" class="image2" style="display:none;align-self: right;;"  src="@/assets/schneider_uba1030.jpg" alt="schneider_hb">
...
<img id="img4_3" class="image2" style="display:none; align-self: right;"  src="@/assets/schneider_mad120.jpg" alt="schneider_niere_re_langs">
<img id="img4_4" class="image2" style="display:none ; align-self: right;"   src="@/assets/schneider_mad995.jpg" alt="schneider_niere_re_quer">
