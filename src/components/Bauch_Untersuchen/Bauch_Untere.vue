<template>
  ...
  Haut bds. o.p.B., beide Beine gleichmäßig rosig, bds. keine Varizen, Ödeme, Atrophien oder Faszikulationen, keine Nagelveränderungen, keine Fußdeformitäten, Beckenstand gerade, keine Beinlängendifferenz, keine trophischen Störungen, Femoralis-, Popliteal- und Fußpulse bds. palpabel, Puls ca. 68/min, beide Füße gleich warm, Rekapilarisationszeit bds. &lt;2Sek.
  </h3>
 ...
 Normale und beschwerdefreie Beweglichkeit in Hüft-, Knie- und Fußgelenken.
  ...
  <h3 id="mundanswer" style="display: none">
   Sensibilität bds. für alle Qualitäten intakt, grobe Kraft allseits KG 5/5, Feinmotilität allseits unauffällig, Tonus unauffällig, Beinvorhalteversuch(Anwinkeln im 90° Winkel): kein Absinken. Reflexe seitengleich mittellebhaft auslösbar, Knie-Hacke-Versuch zielsicher, Babinski bds. negativ, Romberg- und Unterberger-Versuch unauffällig, Einbeinstand
unauffällig, Fersen- und Zehenspitzengang unauffällig, Blind- und Strichgang unauffällig, Lasègue bds. negativ.
  </h3>
  <h3 id="ohrenanswer" style="display: none">
   Beide Beine gleichmäßig rosig, bds. keine Varizen oder Ödeme, keine trophischen Störungen, Femoralis-, Popliteal- und Fußpulse bds. palpabel, Puls ca. 68/min, beide Füße gleich warm, Rekapilarisationszeit bds. &lt;2Sek.
  </h3>
</template>
...
import Kopf from "@/components/Bauch_Untersuchen/Bauch_Kopf.vue";
import Rumpf from "@/components/Bauch_Untersuchen/Bauch_Rumpf.vue";
import Obere from "@/components/Bauch_Untersuchen/Bauch_Obere.vue";
import Untere from "@/components/Bauch_Untersuchen/Bauch_Untere.vue";
import Genital from "@/components/Bauch_Untersuchen/Bauch_Genital.vue";
