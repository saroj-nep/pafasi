<template>
  <div class="grid grid-cols-1 gap-2">
    ...
    <h1 style="font-size:1.5em; " class="h1 text-white text-center" ><b>Wählen Sie aus, welche nicht apparativen Untersuchungen am Abdomen Sie durchführen möchten.​</b> </h1>
    </div>
    <br>
 ...
 <button v-else id="inspektionquestion"  class="button btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-xl"
      ...
      <h3 id="inspektionanswer" style="display:none">Die Patientin bewegt sich vorsichtig zur Liege und hat deutliche Schmerzen beim Hinlegen. Haut: o.p.B., Bauchnabelpiercing, Tatoo an der linken Leiste, leicht adipöser EZ. Abdomen: Beginn der Palpation im linken Unterbauch, dort leichte Abwehrspannung. Verschiebliche, schmerzfreie Resistenz im linken Unterbauch, am ehesten mit Faeces gefüllter Darm/Koprostase.  Blumberg positiv. Bei Fortschreiten der Palpation nach rechts zunehmende Abwehrspannung und deutlicher Druckschmerz rechts, Mc Burney positiv, Lanz positiv, Psoas-Zeichen positiv. Kein eindeutiger Flankenklopfschmerz. Unterer Leberrand bei tiefer Inspiration 1 cm unter dem Rippenbogen tastbar und glatt, Gallenblase nicht tastbar. Bauchhautreflexe in allen Etagen auslösbar. Optisch sowie palpatorisch keine feststellbaren Schwellungen oder Hernien. Beim Aufrichten wieder starke Schmerzen. Sie bitten die Patientin sich auf die Zehen zu stellen und dann auf die Fersen fallen zu lassen (Rüttelschmerz). Dies kann sie vor Schmerzen kaum ausführen.</h3> 
         <h3 id="naseanswer" style="display:none">Abdomen: spärliche Darmgeräusche in allen vier Quadranten, unterer Leberrand auf Höhe des Rippenbogens perkutierbar.</h3> 
...
export default {
 name:"Untersuchens",
  ...
  axios.get( "./Api/bauch_api.php?action=getclicks",)
