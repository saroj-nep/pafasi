<template>
  ...
  beide Mammae symmetrisch, keine Schwellung/Rötung/Überwärmung, keine Seketion der Mamillen, keine Einziehung, palpatorisch ist der Drüsenkörper weich, kleinlobulär, drüsig, keine Knoten tastbar, keine Lymphknoten tastbar.
  </h3>
