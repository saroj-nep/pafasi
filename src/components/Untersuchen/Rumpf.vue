<template>
  <div class="grid grid-cols-1 gap-2">
    ...
    <h1 class="h1 text-white " style=";"> <strong>Wählen Sie aus, was Sie für 'Nicht Apparative Untersuchen: Rumpf' sehen möchten  </strong> </h1>
    </div>
    <br>
...
export default {
 name:"Untersuchens",
  ...
  components: { Popup, Notepad, Thorax,Abdomen, Wirbel}
}
</script>
