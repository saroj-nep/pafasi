<template>
  ...
  <li>Alter: 41 Jahre; Größe: 1,68m</li>
  <li>letzte Vorstellungen: Präventions-Check-up vo 1 Jahr, vor 4 Monaten Vorstellung zwecks Krankmeldung bei banalem Atemwegsinfekt.</li>
  <li>Keine bekannten Vorerkrankungen.</li>
  <li>Nickelallergie.</li>
   </ul>
      </div>
    </div>
