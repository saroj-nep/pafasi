3<template>
  ...
  Haut: o.p.B., Halsvenen nicht gestaut, Thorax: symmetrisch, keine Thoraxdeformitäten, Rippen durchgängig tastbar, keine Konturunterbrechung, keine Thoraxinstabilität, seitengleiche Atemexkursionen, Atemfrequenz etwa 12/min, Herzspitzenstoß deutlich tastbar.
  </h3>
  <h3 id="naseanswer" style="display: none">
   Herz: Herztöne rein, 3. Herzton, rhythmisch, Herzfrequenz ca. 68/min, kein vitientypisches Geräusch, keine Strömungsgeräusche über den Carotiden, Lunge: vesikuläre Atemgeräusche bds., basal leichte Rasselgeräusche, thorakal bds. sonorer Klopfschall, Lungengrenzen etwa bei BWK 10-11, normale Atemverschieblichkeit.
  </h3>
</template>
