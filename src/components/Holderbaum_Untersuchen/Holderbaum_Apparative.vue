<template>
  ...
  <h3 id="inspektionanswer" style="display: none">36,7 °C</h3>
  <h3 id="naseanswer" style="display: none">122 mg/dl</h3>
  <h3 id="halsanswer" style="display: none">143/85 mmHg</h3>
</template>
...
import Sonography from "@/components/Holderbaum_Untersuchen/Holderbaum_Sonography.vue";
import Ekg from "@/components/Holderbaum_Untersuchen/Holderbaum_Ekg.vue";
import Lung from "@/components/Holderbaum_Untersuchen/Holderbaum_Lung.vue";
