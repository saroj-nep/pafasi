<template>
 ...
 <button v-else id="inspektionquestion"  class="button btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-xl"
      ...
      <h3 id="inspektionanswer" style="display:none">Haut: o.p.B., Abdomen: Abdomen weich, keine Abwehrspannung, keine Resistenzen, mäßiger Druckschmerz im Epigastrium, unterer Leberrand 1cm unter dem Rippenbogen tastbar, Gallenblase nicht tastbar, kein Rüttelschmerz, Bauchhautreflexe in allen Etagen schwach auslösbar.</h3> 
         <h3 id="naseanswer" style="display:none">Abdomen: wenige leise Darmgeräusche in allen vier Quadranten, unterer Leberrand auf Höhe des Rippenbogens, tympaner Klopfschall (als Zeichen für Meteorismus).</h3> 
...
export default {
 name:"Untersuchens",
  ...
  axios.get( "./Api/holderbaum_api.php?action=getclicks",)
