            ...
            <form>
              ...
              >
                ...
                <h2>
                  <strong
                    ><b
                      ><span style="font-size: 2.2ex; padding-left: 1%"
                        >Wiedervorstellung:</span
                      ></b
                    ></strong
                  >
                </h2>
  ...
  methods: {
    ...
    sendvalue() {
      ...
      axios
        .post(
          ...
          "./Api/holderbaum_api.php?action=sendsubmit1",
          data
        )
        .then((res) => {
          if (res.data.error) {
    ...
    submitcounter() {
      ...
      if (a.checked == 1) {
        ...
        data.append("safety", 50);
        data.append("economy", -2.632);
      } else if (e.checked == true) {
        data.append("safety", 75);
        data.append("economy", 5.244);
      } else if (f.checked == true) {
        data.append("safety", 30);
        data.append("economy", -2.632);
      } else if (g.checked == true) {
        data.append("safety", 10);
        data.append("economy", -2.632);
      }
      data.append("step", "Sie haben Ihre Diagnose eingereicht");
      data.append("onlineuser", localStorage.email);
      ...
      axios
        .post(
          // "./Api/api.php?action=countervariable",
          "./Api/holderbaum_api.php?action=submitvariable",
          data
        )
        .then((res) => {
          if (res.data.error) {
