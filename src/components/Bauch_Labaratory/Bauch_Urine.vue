...
import Sendurine from "./Bauch_Sendurine.vue";
...
export default {
  ...
  methods: {
    ...
    sendValue() {
      ...
      data.append("betahcg", d.checked);
      data.append("onlineuser", localStorage.email);
      axios
        .post(
          // "./Api/api.php?action=login",
          "./Api/bauch_api.php?action=sendurine",
          data
        )
        .then((res) => {
          if (res.data.error) {
    ...
    urinetimecounter() {
      ...
      if (c.checked == 1) {
        ...
        data.append("time", 15);
        data.append("step", "Sie haben die Urin-beta HCG beantragt");
        data.append("onlineuser", localStorage.email);
        axios
          .post(
            // "./Api/api.php?action=countervariable",
    ...
    urinecounter() {
      ...
      } else if (d.checked == 1 && a.checked==1) {
        data.append("satisfaction", 0);
      ...
      else if (d.checked == 1 && a.checked==0) {
        data.append("satisfaction", 0);
