...
export default {
  ...
  methods: {
    ...
    sendvalue() {
      ...
      axios
        .post(
          ...
          "./Api/bauch_api.php?action=sendblood",
          data
        )
        .then((res) => {
          if (res.data.error) {
    ...
    bloodcounter() {
      ...
      if (a.checked==true && d.checked==false && r.checked== false)
      {data.append("economy",5.88)}
      
      else if (a.checked==false && d.checked==false && r.checked== false)
      {data.append("economy",-2.94)}

      else if (a.checked==true && d.checked==true && r.checked== false)
      {data.append("economy",11.76)}
      
      else if (a.checked==true && d.checked==true && r.checked== true)
      {data.append("economy",17.64)}

      else if (a.checked==false && d.checked==true && r.checked== false)
      {data.append("economy",5.88)}

      else if (a.checked==false && d.checked==false && r.checked== true)
      {data.append("economy",5.88)}
       
      else if (a.checked==false && d.checked==true && r.checked== true)
      {data.append("economy",11.76)}
     
      else if (a.checked==true && d.checked==false && r.checked== true)
      {data.append("economy",11.76)}
