...
import Nichtapparative from '@/components/Meier_Untersuchen/Meier_Nichtapparative.vue';
import Apparative from '@/components/Meier_Untersuchen/Meier_Apparative.vue';
