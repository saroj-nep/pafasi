<template>
  <div class="grid grid-cols-1 gap-2">
   ...
   <h3 id="inspektionanswer" style="display:none">Haut: o.p.B., stark ausgeprägtes männliches Behaarungsmuster, Halsvenen nicht gestaut, Thorax: symmetrisch, keine Thoraxdeformitäten, Rippen durchgängig tastbar, keine Konturunterbrechung, keine Thoraxinstabilität, seitengleiche Atemexkursionen, Atemfrequenz etwa 12/min, Herzspitzenstoß regelrecht tastbar. </h3> 
