<template>
  <div class="grid grid-cols-1 gap-2">
    <div class="sticky top-0 bg-emerald-600">
      <h1 style="font-size: 1.5em" class="h1 text-white text-center">
        <b
          >Wählen Sie aus, welche nicht apparativen Untersuchungen am Abdomen
          Sie durchführen möchten.​</b
        >
      </h1>
    </div>
    <br />
  ...
  <h3 id="inspektionanswer" style="display: none">
    Haut: o.p.B., stark ausgeprägtes männliches Behaarungsmuster. Abdomen:
    Androides Fettverteilungsmuster mit praller Vorwölbung des adipösen
    Abdomens. Keine sicht- oder tastbare Nabelhernie. Abdomen weich, keine
    Abwehrspannung, kein Druckschmerz. Verschiebliche, schmerzfreie Resistenz im
    linken Unterbauch, am ehesten i.S. mit Faeces gefüllter Darm/Koprostase.
    Unterer Leberrand ca. 1,5cm unter dem Rippenbogen tastbar und glatt,
    Gallenblase nicht tastbar. Blumberg, Lanz und McBurney negativ.
    Flankenklopfschmerz links. Bauchhautreflexe in allen Etagen auslösbar.
  </h3>
  <h3 id="naseanswer" style="display: none">
    Spärliche Darmgeräusche in allen vier Quadranten. Unterer Leberrand 1
    Querfinger unterhalb des Rippenbogens perkutierbar.
  </h3>
</template>
...
export default {
  ...
  methods: {
    ...
    countertimeInspektion() {
      ...
      data.append(
        "step",
        "Sie haben Inspektion und Palpation unter Nicht Apparative Untersuchen: Rumpf-Abdomen angekreuzt"
      );
    ...
    countertimeNase() {
      ...
      data.append(
        "step",
        "Sie haben Auskultation & Perkussion unter Nicht Apparative Untersuchen: Rumpf-Abdomen angekreuzt"
      );
      data.append("onlineuser", localStorage.email);
      axios
        .post(
