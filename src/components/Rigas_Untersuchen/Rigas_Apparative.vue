<template>
  ...
  <h3 id="inspektionanswer" style="display: none">36.9 °C</h3>
  <h3 id="naseanswer" style="display: none">130 mg/dl</h3>
  <h3 id="halsanswer" style="display: none">145/90 mmHg</h3>
</template>
...
import Sonography from "@/components/Rigas_Untersuchen/Rigas_Sonography.vue";
import Ekg from "@/components/Rigas_Untersuchen/Rigas_Ekg.vue";
import Lung from "@/components/Rigas_Untersuchen/Rigas_Lung.vue";
