<template>
    ...
    <div class="sticky top-0 bg-emerald-600">
      <h1 style="font-size: 1.5em" class="h1 text-white text-center">
        <b
          ...
          Genital- und Glutealregion Sie durchführen möchten.​</b
        >
      </h1>
    </div>
    <br />
  ...
  <h3 id="inspektionanswer" style="display: none">
    Haut o.p.B., insbes. keine Rötungen, Bläschen oder Rhagaden, keine
    Wucherungen, geschlechtstypisches Behaarungsmuster, kein Ausfluss aus der
    Harnröhre, optisch sowie palpatorisch keine feststellbaren Schwellungen oder
    Hernien. Vorhaut komplett reponibel, Glans reizlos, Skrotum weich, beide
    Hoden tastbar, keine Knoten oder Verhärtungen, keine Varikosis, keine
    Druckschmerzhaftigkeit.
  </h3>
  <h3 id="naseanswer" style="display: none">
    Kein Hervortreten von Schleimhaut, Analreflex normal auslösbar, normaler
    Sphinktertonus, Schleimhaut gleichmäßig, weich und verschieblich, keine
    Raumforderungen, keine Schmerzauslösung, kein Blut am Fingerling. Prostata
    prallelastisch tastbar, kastaniengroß, glatt, kugelig, flacher Sulcus,
    schmerzlos.
  </h3>
</template>
...
export default {
  ...
  methods: {
    ...
    countertimeInspektion() {
      ...
      data.append(
        "step",
        "Sie haben Inspektion & Palpation unter Nicht Apparative Untersuchen: Genital- und Glutealregion angekreuzt"
      );
    ...
    countertimeNase() {
      ...
      data.append(
        "step",
        "Sie haben digital rektale Untersuchung unter Nicht Apparative Untersuchen: untere Extremität angekreuzt"
      );
      data.append("onlineuser", localStorage.email);
      axios
        .post(
