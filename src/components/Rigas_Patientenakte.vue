  ...
  <div>
    <div class="sticky top-0 bg-emerald-600">
      <h1 style="font-size: 1.5em" class="h1 text-white text-center">
        <b>Der Patientenakte können Sie Folgendes entnehmen: </b>
      </h1>
    </div>
    <div style="margin-top: 50px">
      <ul class="marker:text-green list-outside list-disc ml-6">
        <li>Alter 46 J.</li>
        <li>Patient in ihrer Praxis seit 10 Jahren.</li>
        <li>
          Beim Check-up vor 6 Jahren auffällig ein BMI von 30,
          Gesamt-Cholesterin 240 mg/dl, LDL-Cholesterin 180 mg/dl,
          HDL-Cholesterin 63 mg/dl. Diesbezüglich Beratung zur
          Lebensstiländerung und Gewichtsabnahme. Grenzwertig-hohe
          Blutdruckwerte (140/90) sollten wieder kontrolliert werden. Eine
          Kontrolle ist scheinbar nicht erfolgt.
        </li>
        <li>
          Ansonsten keine Vorerkrankungen. Die meisten Vorstellungen bzgl.
          Bagatellen.
        </li>
      </ul>
    </div>
...
export default {
  ...
  methods: {
    sendthesteps() {
      ...
      data.append(
        "step",
        "Der Benutzer ist auf dem Patientenakte Seite gelandet."
      );
