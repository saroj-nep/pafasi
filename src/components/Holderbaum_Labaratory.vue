  ...
  <div>
    ...
    <br>
       <button  color="#42b983" class="button btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-xl"
            @click.prevent="TogglePopup('laboranordnungenTrigger');TogglePopup('bloodTrigger')">
         Blutentnahme
         </button>
          ...
          <button color="#42b983" class="button btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-xl"
          @click.prevent="TogglePopup('laboranordnungenTrigger');TogglePopup('urineTrigger')">
            Urindiagnostik
          </button>
          ...
          <button  color="#42b983" class="button btn shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] text-black bg-white ease-out hover:translate-y-1 transition-all rounded shadow-xl"
          @click.prevent="TogglePopup('laboranordnungenTrigger'); TogglePopup('stoolTrigger')">
          Stuhlprobe
          </button>
...
import Blood from "./Holderbaum_Labaratory/Holderbaum_Blood.vue";
import Urine from "./Holderbaum_Labaratory/Holderbaum_Urine.vue";
import Stool from "./Holderbaum_Labaratory/Holderbaum_Stool.vue";
import TotalNextday from './Holderbaum_Labaratory/Holderbaum_TotalNextday.vue';
...
sendthesteps(){
    var data = new FormData();
     data.append("step","Der Benutzer ist auf dem Laboranordnungen-Menü gelandet.")
