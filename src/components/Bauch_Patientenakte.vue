<template>
  ...
  <li>29 Jahre.</li>
  <li>Lebt seit 25 Jahren in Deutschland, kam als Kind mit den Eltern aus Polen.</li>
  <li>Sie ist Patientin in Ihrer Praxis erst seit 1 Jahr.</li>
  <li>Vorerkrankungen: Hypothyreose, Substitution durch L-Thyroxin 75µg.</li>
  <li>Kommt selten in die Praxis. Die meisten Einträge betreffen banale Atemwegsinfekte. Regelmäßige Folgeverordnungen von L-Thyroxin.</li>
   </ul>
      </div>
    </div>
