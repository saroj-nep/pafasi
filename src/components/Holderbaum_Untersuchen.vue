...
import Nichtapparative from '@/components/Holderbaum_Untersuchen/Holderbaum_Nichtapparative.vue';
import Apparative from '@/components/Holderbaum_Untersuchen/Holderbaum_Apparative.vue';
