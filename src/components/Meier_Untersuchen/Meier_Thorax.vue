<template>
  <div class="grid grid-cols-1 gap-2">
    <div class="bg-emerald-600">
      <h1 style="font-size: 1.5em" class="h1 text-white text-center">
        <b
          >Wählen Sie aus, welche nicht apparativen Untersuchungen Sie am Thorax
          (Herz & Lunge) durchführen möchten.</b
        >
      </h1>
    </div>
    <br />
  ...
  <h3 id="inspektionanswer" style="display: none">
    Haut: helle Haut,  multiple Naevi unauffäliger Größe und Gestalt, ansonsten o.p.B.. Halsvenen nicht gestaut, Thorax: symmetrisch, keine Thoraxdeformitäten, Rippen durchgängig tastbar, keine Konturunterbrechung, keine Thoraxinstabilität, seitengleiche Atemexkursionen, Atemfrequenz etwa 14/min, Herzspitzenstoß regelrecht tastbar.
  </h3>
  <h3 id="naseanswer" style="display: none">
    Herz: Herztöne rein, rhythmisch, Herzfrequenz ca. 72/min, kein vitientypisches Geräusch, keine Strömungsgeräusche über den Carotiden. Lunge: vesikuläre Atemgeräusche bds., keine Nebengeräusche, thorakal bds. sonorer Klopfschall, Lungengrenzen etwa bei BWK 10-11, normale Atemverschieblichkeit.
  </h3>
</template>
...
export default {
  ...
  methods: {
    ...
    countertimeInspektion() {
      ...
      data.append(
        "step",
        "Sie haben Inspektion & Palpation unter Nicht Apparative Untersuchen: Rumpf-Thorax angekreuzt"
      );
    ...
    countertimeNase() {
      ...
      data.append(
        "step",
        "Sie haben Auskultation & Perkussion unter Nicht Apparative Untersuchen: Rumpf-Thorax angekreuzt"
      );
      data.append("onlineuser", localStorage.email);
      axios
        .post(
    ...
    counterNase() {
      ...
      data.append(
        "step",
        "Sie haben Auskultation & Perkussion unter Untersuchungen ohne Apparat ausgewählt: Rumpf-Thorax."
      );
      data.append("onlineuser", localStorage.email);
      axios
        .post(
