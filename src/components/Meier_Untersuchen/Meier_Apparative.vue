<template>
  ...
  <h3 id="naseanswer" style="display: none">110 mg/dl</h3>
  <h3 id="halsanswer" style="display: none">130/70 mmHg</h3>
</template>
...
import Sonography from "@/components/Meier_Untersuchen/Meier_Sonography.vue";
import Ekg from "@/components/Meier_Untersuchen/Meier_Ekg.vue";
import Lung from "@/components/Meier_Untersuchen/Meier_Lung.vue";
