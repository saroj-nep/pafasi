<template>
  ...
  <h3 id="inspektionanswer" style="display: none">
    In Ruhe leichte Schonhaltung nach links. Nach Aufrichten zur Untersuchung kein Schulter- oder Beckenschiefstand, paravertebraler Hartspann lumbal, kein WS-Klopfschmerz.
  </h3>
  <h3 id="naseanswer" style="display: none">
   Bei Vorbeugung/Anteversion keine Schmerzen, kein Hinweis auf ausgeprägte Skoliose, kein Vorlaufphänomen. Beim Hochkommen/Retroversion starke einschießende Schmerzen mit Austrahlung in rechtes Gesäß Lateroflexion sowie Rotation nach links mit normaler Beweglichkeit, nach rechts leichte Schmerzen. Kein Rüttelschmerz, Lasègue rechts bei ca 45° positiv mit einschießenden Schmerzen ins Gesäß, links negativ. Kein Meningismus.
  </h3>
