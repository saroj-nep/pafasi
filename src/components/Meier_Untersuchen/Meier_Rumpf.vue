...
import Thorax from '@/components/Meier_Untersuchen/Meier_Thorax.vue';
import Mammae from '@/components/Meier_Untersuchen/Meier_Mammae.vue';
import Wirbel from '@/components/Meier_Untersuchen/Meier_Wirbel.vue';
import Abdomen from '@/components/Meier_Untersuchen/Meier_Abdomen.vue';
