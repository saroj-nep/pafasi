<template>
  ...
  <h3 id="inspektionanswer" style="display: none">
    Beide Mammae symmetrisch, keine Schwellung/Rötung/Überwärmung. Keine Seketion der Mamillen. Keine Einziehung. Palpatorisch ist der Drüsenkörper weich, kleinlobulär, drüsig. Keine Knoten tastbar, keine Lymphknoten tastbar, keine Schmerzen.
  </h3>
