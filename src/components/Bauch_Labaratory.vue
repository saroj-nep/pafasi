...
import Blood from "./Bauch_Labaratory/Bauch_Blood.vue";
import Urine from "./Bauch_Labaratory/Bauch_Urine.vue";
import Stool from "./Bauch_Labaratory/Bauch_Stool.vue";
import TotalNextday from './Bauch_Labaratory/Bauch_TotalNextday.vue';
