...
import Nichtapparative from '@/components/Rigas_Untersuchen/Rigas_Nichtapparative.vue';
import Apparative from '@/components/Rigas_Untersuchen/Rigas_Apparative.vue';
