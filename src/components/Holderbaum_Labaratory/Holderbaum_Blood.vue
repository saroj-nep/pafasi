...
import Sendblood from "./Holderbaum_Sendblood.vue";
...
export default {
  ...
  methods: {
    ...
    sendvalue() {
      ...
      axios
        .post(
          ...
          "./Api/holderbaum_api.php?action=sendblood",
          data
        )
        .then((res) => {
          if (res.data.error) {
    ...
    bloodcounter() {
      ...
      if (a.checked==true){ economyvalue+=5.264}
         if (c.checked==true){ economyvalue+=5.264}
            if (d.checked==true){ economyvalue+=5.264}
               if (h.checked==true){ economyvalue+=5.264}
                  if (i.checked==true){ economyvalue+=5.264}
                     if (j.checked==true){ economyvalue+=5.264}
                        if (k.checked==true){ economyvalue+=5.264}
                           if (o.checked==true){ economyvalue+=5.264}

     
      data.append ("economy",economyvalue)
