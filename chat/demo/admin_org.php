...
if(isset($_POST['showroombg']) && isset($_POST['bothrefnovality']) && isset($_POST['reference']) && isset($_POST['novalty']) && isset($_POST['usercontrol']) && isset($_POST['ttonoff']) && isset($_POST['amapponoff']) && isset($_POST['roombgc']) && isset($_POST['roombgf']) && isset($_POST['roombgt']) && isset($_POST['roombgs']) && isset($_POST['roombgl'])){  

$showroombg=(int)$_POST['showroombg'];   
neutral_query('UPDATE '.$dbss['prfx']."_settings SET value='$showroombg' WHERE id='showroombg'");
/* sentence starter on off admin controller setings code*/	
$bothrefnovality=(int)$_POST['bothrefnovality'];   
neutral_query('UPDATE '.$dbss['prfx']."_settings SET value='$bothrefnovality' WHERE id='bothrefnovality'");	
