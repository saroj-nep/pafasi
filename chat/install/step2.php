...
$install[]="INSERT INTO ".$dbss['prfx']."_settings VALUES('msg_template','<div class=\"msg\"><img class=\"avt x_circle\" src=\"{AVATAR}\" alt=\"\" /><div><span class=\"chat_area_user g{GROUP}\">{NAME}</span> <span class=\"chat_area_time\">{TIME}</span><br /><span class=\"tt{COLOR}\" style=\"word-break:break-word\">{TEXT}</span></div></div>')";
...
$install[]="INSERT INTO ".$dbss['prfx']."_settings VALUES('novalty','1')";
$install[]="INSERT INTO ".$dbss['prfx']."_settings VALUES('reference','1')";
$install[]="INSERT INTO ".$dbss['prfx']."_settings VALUES('eduTechEsc_disabled','0')";
$install[]="INSERT INTO ".$dbss['prfx']."_settings VALUES('eduTechIsTyping','1')";
$install[]="INSERT INTO ".$dbss['prfx']."_settings VALUES('eduTechIsTypingTimer','5000')";
